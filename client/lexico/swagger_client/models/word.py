...
class Word(object):
    ...
    def word(self, word):
        ...
        if len(word) > 100:
            raise ValueError("Invalid value for `word`, length must be less than `100`")
    ...
    def audio(self):
        """
        Gets the audio of this Word.
        URL to the audio pronunciation of the word

        :return: The audio of this Word.
        :rtype: str
        """
        return self._audio
    ...
    def audio(self, audio):
        """
        Sets the audio of this Word.
        URL to the audio pronunciation of the word

        :param audio: The audio of this Word.
        :type: str
        """
    ...
    def synonyms(self):
        ...
        :return: The synonyms of this Word.
        :rtype: list[str]
        """
    ...
    def synonyms(self, synonyms):
        """
        Sets the synonyms of this Word.
        List of synonyms for the word

        :param synonyms: The synonyms of this Word.
        :type: list[str]
        """
